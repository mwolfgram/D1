...
def courseView(course_name):
    return "welcome to {}".format(course_name) #dynamic url!
...
def resultView():
    ...
    #{'ingredient' : 'eggs'}
    #p['ingredient'] -- .get['ingredient']

    if request.method == "POST":
        #ingredient = request.args #contains key/val pair
    ...
    #Step 3 : Make an API request to Recipe API and parameters in Step 2
        ...
        response = requests.get(baseurl, params = params) #builds the link with i = ingredient
